...
4. Hand the Project Lead the single confirmation pop-up to show the user
   ...
   that the user agreed, in the project's own record, **before** the next step
   (2026-08-16, X214: there is no confirmation script or publish gate any more —
   Claude Code's own permission prompt is the authorisation, and `hooks/scan.mjs`
   still refuses a push carrying secrets) (2026-07-10 Round 4 fix: the publish-gate hook
